...
def frenet_optimal_planning(csp, s0, c_speed, c_d, c_d_d, c_d_dd, ob, faTrajX, faTrajY, fpplist, faTrajCollisionX, faTrajCollisionY, faObCollisionX, faObCollisionY):
...
def main_frenet(data_dir):
    ...
    position_path = os.path.join(data_dir,"pseudo_simulator_7.txt") # position_path = os.path.join(data_dir,"position_all.txt")
    ...
    for frame_ids in range(int(starting_frame), len(free)-2):
        ...
        for i in range(1):
            path, faTrajX, faTrajY, fpplist, faTrajCollisionX, faTrajCollisionY = frenet_optimal_planning(csp, s0, c_speed, c_d, c_d_d, c_d_dd, ob, faTrajX, faTrajY, fpplist, faTrajCollisionX, faTrajCollisionY, faObCollisionX, faObCollisionY)
        ...
        print("jaga_jarak_depan = ", jaga_jarak_depan)
        print("jaga_jarak_belakang = ", jaga_jarak_belakang)
        # print("tujuan = ", wx[1])

        if term == 1:
            if jaga_jarak_belakang <= 20:
                c_speed = c_speed
            if jaga_jarak_belakang > 20:
                c_speed -= 0.2
        elif term == 2:
